...
(
    ...
    event_count integer,
    CONSTRAINT events_hourly_pkey PRIMARY KEY (hour)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.events_hourly
    OWNER to postgres;

REVOKE ALL ON TABLE public.events_hourly FROM analytics_user;

GRANT SELECT ON TABLE public.events_hourly TO analytics_user;

GRANT ALL ON TABLE public.events_hourly TO postgres;
